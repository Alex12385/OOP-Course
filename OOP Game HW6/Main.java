...
public class Main {
    ...
    public static void main( String[] args ) {
        ...
        System.out.println( AnsiColors.ANSI_RED_BACKGR  + " --- Визуализация проекта --- " + AnsiColors.ANSI_RESET);

        while( true ) {
            if ( input.equals( "q" ) ) break;
            ConsoleView.view();

            System.out.println( "\n" + AnsiColors.ANSI_RED_BACKGR  + "  --- Визуализация проекта ---  " + AnsiColors.ANSI_RESET + "\n");
